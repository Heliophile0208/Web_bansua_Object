...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (is_array($result)) {
        ...
        $ma_sua = $result['ma_sua'];  // Lấy ma_sua từ kết quả trả về
        $message = 'Sản phẩm đã được thêm thành công.';
        
        // Lấy thông tin sản phẩm từ cơ sở dữ liệu
        $new_product = $xl_sua->lay_thong_tin_chi_tiet($ma_sua);  // Lấy thông tin sản phẩm vừa thêm
    } else {
        // Lỗi khi thêm sản phẩm
        $error = $result;  // Thông báo lỗi
    }
}
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <div class="form-container">
                ...
                <!-- Hiển thị thông tin sản phẩm sữa nếu thêm thành công -->
